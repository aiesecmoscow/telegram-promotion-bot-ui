...
- Поддержка двухфакторной аутентификации (2FA-пароль).
...
Завершает авторизацию по коду (и 2FA-паролю при необходимости).
...
- Коды ошибок: `400` (неверный код), `401` (требуется/неверный 2FA-пароль).
